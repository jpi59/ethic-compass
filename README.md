...
direction changes, and paired with a high-contrast compass. The drawing is
created entirely in code from simple geometric primitives; no third-party
images, fonts, trackers or SDKs are included.
